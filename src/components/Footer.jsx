        ...
        {SOFT_LAUNCH ? (
          ...
          <div className="text-center mb-12">
            ...
            <div className="space-y-2">
              <p className="font-semibold text-cyan-300">Sunday Worship: 10:00 AM</p>
              <p className="text-blue-100">6551 Soledad Mountain Rd, La Jolla, CA 92037</p>
              <a href="tel:8584593865" className="text-cyan-300 hover:text-white transition-colors">
                (858) 459-3865
              </a>
            </div>
          </div>
        ) : (
          /* Full Launch - Complete Footer */
