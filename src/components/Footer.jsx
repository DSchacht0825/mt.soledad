...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-blue-900 via-blue-700 to-cyan-600 text-white relative overflow-hidden">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <motion.a
                ...
                className="w-10 h-10 bg-white/10 hover:bg-cyan-400 rounded-full flex items-center justify-center transition-all"
              >
